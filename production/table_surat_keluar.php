                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <p class="text-muted font-13 m-b-30">
                                    Daftar Admin Pengelola Surat</p>
                                <table id="datatable-buttons" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($connect->query($sql) as $row) {
                                          echo "<tr>";
                                          echo "<td style='font-size:smaller;'>" . $row['nama'] . "</td>";
                                          echo "<td style='font-size:smaller;'>" . $row['jabatan'] . "</td>";
                                          echo "<td style='font-size:smaller;'>" . $row['email'] . "</td>";
                                          echo "<td style='font-size:smaller;'>" . $row['nip'] . "</td>";
                                          echo "<td style='font-size:smaller;'>" . $row['alamat'] . "</td>";
                                          echo "<td style='font-size:smaller;'>" . $row['telepon'] . "</td>";
                                          echo "<td style='font-size:smaller;'>" . $row['username'] . "</td>";
                                          echo "</tr>";
                                        }
                                        ?>
                                    </tbody>
